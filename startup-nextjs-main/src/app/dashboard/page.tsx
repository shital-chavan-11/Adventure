...
import { Home, Hotel, PartyPopper, Map, User, LogOut } from "lucide-react";
...
const Dashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white"> {/* ✅ Default Dark Mode */}
      {/* Sidebar */}
      <aside className="w-64 bg-gray-800 p-6 shadow-lg fixed h-full">
      ...
      <main className="flex-1 ml-64 p-8">
        {/* Top Right Section - Profile Dropdown */}
        <div className="flex justify-end items-center space-x-4 mb-6">
          ...
          <div className="relative profile-dropdown">
            ...
            {/* Dropdown Menu */}
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-44 bg-gray-800 shadow-md rounded-lg p-2">
                <button
                  onClick={() => router.push("/dashboard/profile")} // ✅ Navigate to Profile Page
                  className="flex items-center w-full px-4 py-2 text-left text-gray-200 hover:bg-gray-700 rounded-lg gap-2"
                >
                  <User size={20} />
                  Profile
                </button>
